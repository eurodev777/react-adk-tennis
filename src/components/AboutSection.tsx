...
import { Trophy, Users, Globe, Flame, Heart, Ship, MapPin, ZoomIn } from 'lucide-react';
...
export const AboutSection: React.FC<AboutSectionProps> = ({ onNavigateTab }) => {
  const [activeSubTab, setActiveSubTab] = useState<'quemsomos' | 'projeto' | 'regiao'>('quemsomos');
  const [selectedPhoto, setSelectedPhoto] = useState<string | null>(null);

  const stats = [
    { label: "Anos de História", val: "13+", icon: Trophy, desc: "Desde 2013 lapidando jovens talentos" },
    { label: "Quadras Oficiais", val: "17", icon: Flame, desc: "15 de saibro (3 cobertas) & 2 rápidas" },
    { label: "Profissionais de Elite", val: "10+", icon: Users, desc: "Coaches ITF Nível 3, preps e fisioterapeutas" },
    { label: "Bolsas de Estudo nos EUA", val: "100+", icon: Globe, desc: "Tenistas recrutados para universidades" }
  ];

  return (
    <section className="py-16 md:py-24 bg-adk-dark text-white border-b border-zinc-900" id="adk-about-composite-section">
      <div className="max-w-7xl mx-auto px-4">
        {/* Navigation bar for sub-topics within About page container */}
        <div className="flex flex-wrap items-center justify-center gap-2 mb-12" id="about-internal-tabs">
          <button
          ...
          <div className="space-y-16" id="about-tab-content-quemsomos">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-6">
                ...
                <h2 className="text-3xl md:text-5xl font-black font-display uppercase tracking-tight leading-none text-white">
                  Formando Campeões para a Vida e para as <span className="text-adk-yellow">Quadras</span>
                </h2>
                <div className="h-1.5 w-20 bg-adk-yellow rounded"></div>
                
                <p className="text-zinc-300 font-sans leading-relaxed text-base">
                  A <strong>ADK Tennis</strong> é um Centro de Treinamento de Tênis situado em Itajaí, SC, focado na formação e desenvolvimento de jovens tenistas voltados à competição e alto rendimento dentro da modalidade.
                </p>
                
                <p className="text-zinc-400 font-sans leading-relaxed text-sm">
                  Utilizamos a consagrada infraestrutura do <strong>Itamirim Clube de Campo</strong> para alinhar a rotina esportiva com as melhores práticas técnico-táticas globais. Sob a visão dos fundadores e diretores técnicos, a academia atua desde a iniciação até o acompanhamento integral em torneios de Grand Slam e da Davis Cup, integrando preparação psicológica, medicina preventiva e scout avançado.
                </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pt-8 border-t border-zinc-850">
              {stats.map((stat, idx) => {
                ...
                return (
                  <div key={idx} className="bg-zinc-950 p-6 rounded border border-zinc-850 hover:border-zinc-750 transition-all duration-200 shadow-lg flex flex-col justify-between">
                    <div>
            ...
            <div className="space-y-8 pt-8">
              <div className="text-center max-w-xl mx-auto space-y-2">
                ...
                <p className="text-xs text-zinc-400">
                  A ADK Tennis utiliza a infraestrutura completa do Itamirim Clube de Campo. Um ecossistema de treinamento absoluto.
                </p>
              </div>
        ...
        {/* Projeto Social */}
        {activeSubTab === 'projeto' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center" id="about-tab-content-projeto">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h2 className="text-3xl md:text-5xl font-black font-display uppercase tracking-tight leading-none text-white">
                O esporte como agente de <span className="text-adk-yellow">transformação</span> humana
              </h2>
              <div className="h-1.5 w-20 bg-adk-yellow rounded"></div>

              <p className="text-zinc-300 font-sans leading-relaxed text-sm">
                A cidadania começa na linha de fundo. A ADK Tennis acredita que o esporte deve transcender os circuitos competitivos profissionais e exercer um forte impacto inclusivo. Por isso, gerimos e patrocinamos o <strong>Projeto Social de Tênis</strong>.
              </p>
              
              <p className="text-zinc-400 font-sans leading-relaxed text-sm">
                Proporcionamos a dezenas de crianças e jovens das escolas públicas de Itajaí acesso gratuito a aulas estruturadas de tênis, material oficial esportivo, acompanhamento educacional e alimentação orientada. Muitos alunos já ascenderam para a pré-competição e hoje competem no cenário nacional, amparados por bolsas de treino financiadas.
              </p>
              ...
              <div className="bg-zinc-950 p-5 rounded border border-zinc-850 flex items-start gap-4">
                ...
                <div>
                  <span className="font-bold text-sm block text-white uppercase">Selo de Impacto Solidário</span>
                  <p className="text-xs text-zinc-400 leading-normal mt-1">
                    Cada vaga preenchida em nossos programas de Alto Rendimento ou Intensivo ajuda a subsidiar aulas práticas de contraturno escolar do projeto de transformação social de base.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* A Região */}
        {activeSubTab === 'regiao' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center text-left" id="about-tab-content-regiao">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="text-3xl md:text-5xl font-black font-display uppercase tracking-tight leading-none text-white">
                Itajaí &amp; Balneário Camboriú, <span className="text-adk-yellow">Santa Catarina</span>
              </h2>
              <div className="h-1.5 w-20 bg-adk-yellow rounded"></div>

              <p className="text-zinc-300 font-sans leading-relaxed text-sm">
                Eleito repetidamente como um dos melhores polos de infraestrutura litorânea e segurança do Brasil, a região de <strong>Itajaí e Balneário Camboriú</strong> oferece o refúgio perfeito de treinos de inverno e verão.
              </p>
              
              <p className="text-zinc-400 font-sans leading-relaxed text-sm">
                Com praias deslumbrantes como a Praia Brava e Cabeçudas, rede hoteleira de alto nível, proximidade ao Aeroporto de Navegantes (NVT) e aeroportos centrais, Itajaí reúne atrativos perfeitos para atletas e familiares que participam das semanas do <strong>Intensivo ADK</strong>. Os tenistas desfrutam de ótimos hotéis, climatologia propícia para preparação aero-anaeróbica e fácil acesso logístico ao Itamirim Clube de Campo.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="bg-zinc-950 p-4 rounded border border-zinc-900 flex items-center gap-3">
                  ...
                  <div>
                    <span className="block font-bold text-xs uppercase text-white">Aeroporto Navegantes</span>
                    <span className="text-[10px] text-zinc-400">Apenas 20min de Itajaí</span>
                  </div>
                </div>
                <div className="bg-zinc-950 p-4 rounded border border-zinc-900 flex items-center gap-3">
                  <MapPin className="w-5 h-5 text-adk-yellow shrink-0" />
                  <div>
                    <span className="block font-bold text-xs uppercase text-white">Praia Brava</span>
                    <span className="text-[10px] text-zinc-400">Hotéis parceiros e turismo</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {selectedPhoto && (
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4" onClick={() => setSelectedPhoto(null)} id="gallery-lightbox">
          <div className="relative max-w-4xl max-h-[85vh]">
            <img src={selectedPhoto} alt="Zoomed Infrastructure View" className="max-w-full max-h-[80vh] object-contain rounded border border-zinc-800" />
            <button
