  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        >
          <div className="w-14 h-14 flex items-center justify-center rounded-sm font-black text-adk-dark text-xl transition-all duration-300 shadow-md group-hover:scale-105">
            <img src={logo} />
          </div>
